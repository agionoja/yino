...
export default function Personalized() {
  return (
    <section className="flex flex-col-reverse items-center gap-6 lg:flex-row">
      <div className="flex basis-[55%] flex-col gap-3">
        ...
        <p className="text-text-gray whitespace-pre-line text-center text-[20px] font-normal leading-8 lg:text-start">
